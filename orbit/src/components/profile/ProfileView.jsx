    ...
    <div className="max-w-2xl mx-auto px-6 py-10 text-white">
      ...
      <div className="flex justify-end gap-2 mb-6">
        <button
          ...
          className="p-2 rounded-xl border border-[color:var(--line)] bg-[color:var(--card)] hover:bg-[#162034] transition"
        >
      ...
      <div className="flex flex-col items-center mb-8 text-center">
        ...
        <p className="text-[color:var(--text-muted)] mb-1">{profile.email}</p>
      ...
      {/* Bio */}
      <div className="bg-[color:var(--card)] rounded-2xl p-6 mb-6 border border-[color:var(--line)]">
          ...
          <div className="space-y-3 text-gray-300">
            {profile.email && (
              <a
                ...
                className="flex items-center gap-3 hover:text-[color:var(--brand)] transition"
              >
        ...
        <div className="bg-[color:var(--card)] rounded-2xl p-6 border border-[color:var(--line)]">
          ...
          <div className="flex flex-wrap gap-2">
            {profile.interests.map((interest, idx) => (
              <span
                key={idx}
                className="px-4 py-2 bg-[#162034] border border-[color:var(--line)] text-gray-300 rounded-full text-sm"
              >
                {interest}
              </span>
            ))}
